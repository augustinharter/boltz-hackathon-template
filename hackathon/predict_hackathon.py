...
# quick args reference for debugging
# --input-jsonl hackathon_data/datasets/abag_public/abag_public.jsonl --msa-dir hackathon_data/datasets/abag_public/msa/ --submission-dir ./my_predictions --intermediate-dir ./tmp/ --result-folder ./my_results
...
def prepare_protein_complex(datapoint_id: str, proteins: List[Protein], input_dict: dict, msa_dir: Optional[Path] = None) -> List[tuple[dict, List[str]]]:
    ...
    cli_args = ["--diffusion_samples", "50", "--use_potentials"]
